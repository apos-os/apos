...
dnl
dnl
PROVIDE(RSV64_FIRST_KERNEL_ADDR,       0xFFFFFFC000000000, ull)
PROVIDE(RSV64_FIRST_USED_KERNEL_ADDR,  0xFFFFFFE000000000, ull)
PROVIDE(RSV64_TSAN_REGION_START,       0xFFFFFFE000000000, ull)
PROVIDE(RSV64_TSAN_REGION_LEN,         0x0000001000000000, ull)
PROVIDE(RSV64_TSAN_SHADOW_START,       0xFFFFFFE000000000, ull)
PROVIDE(RSV64_TSAN_SHADOW_LEN,         0x0000000800000000, ull)
PROVIDE(RSV64_TSAN_MDATA_START,        0xFFFFFFE800000000, ull)
PROVIDE(RSV64_TSAN_MDATA_LEN,          0x0000000800000000, ull)
PROVIDE(RSV64_KPHYSMAP_ADDR,           0xFFFFFFF000000000, ull)
PROVIDE(RSV64_KPHYSMAP_LEN,            0x0000000800000000, ull)
PROVIDE(RSV64_TSAN_MAPPED_START,       0xFFFFFFFF00000000, ull)
PROVIDE(RSV64_TSAN_MAPPED_LEN,         0x0000000100000000, ull)
