...
#ifndef APOO_ARCHS_X86_64_ARCH_DEV_INTERRUPTS_X86_H
#define APOO_ARCHS_X86_64_ARCH_DEV_INTERRUPTS_X86_H
...
_Static_assert(sizeof(idt_entry_t) == 16, "wrong size for idt_entry_t");
