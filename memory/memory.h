...
typedef struct {
  ...
  smmap_region_t kernel_phys;
  smmap_region_t kernel_virt;
  ...
  // The physical-mapped address region.  The first phys_map.len bytes of
  // physical memory are mapped directly into this region.  Any memory above
  // phys_map.len is not physically mapped.
  smmap_region_t phys_map;
