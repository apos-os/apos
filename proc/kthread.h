...
// Detach the given thread, consuming a reference.  The thread's resources will
// be collected once it exits (and all other references, if they exist, are also
// returned with kthread_join() or kthread_detach()).
